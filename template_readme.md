...
```
workflow_stock_status(inputPath, output_path_indicators)
```
...
```
workflow_trans_dates(inputPath, output_path_indicators)
```
...
```
workflow_rec_hms(inputPath,input_path_rec_key, output_path_indicators)
```
