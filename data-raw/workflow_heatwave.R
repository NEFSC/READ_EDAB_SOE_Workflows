...
#' workflow_heatwave(input_path_gb_bot = "path/to/input/GBdata.csv",
  ...
  tryCatch(
    {
      ...
      # calculate indicator
      indicatorData <- SOEworkflows::create_heatwave(
      ...
      # write data to file
      saveRDS(indicatorData, paste0(output_path_indicators, "/heatwave.rds"))
