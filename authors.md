...
- **Joseph Caracappa**. Author, maintainer.

- **Andy Beet**. Author. [](https://orcid.org/0000-0001-8270-7090)

- **Abigail Tyrell**. Author.

- **Stephanie Owen**. Author.

- **Maxwell Grezlik**. Author.

- **Brandon Beltz**. Author.

## Citation

Source:
[`DESCRIPTION`](https://github.com/NEFSC/READ_EDAB_SOE_Workflows/blob/v1.0.0/DESCRIPTION)
...
report*. R package version 1.0.0,
